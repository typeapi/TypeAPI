    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (model.schemas) {
                ...
                Object.keys(model.schemas).forEach(function (v, i, a) {
                    ;
                    __append("    ");
            ...
            if (model.parameters && Object.keys(model.parameters).length) {
                ...
                Object.keys(model.parameters).length && Object.keys(model.parameters).forEach(function (v, i, a) {
                    ;
                    __append("    export interface ");
                    __append(v);
                    __append("{\n");
                    Object.keys(model.parameters[v]).length && Object.keys(model.parameters[v]).forEach(function (vv, ii, aa) {
                        ;
                        __append("         ");
                        __append(vv);
                        __append(": ");
