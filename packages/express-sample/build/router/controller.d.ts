/// <reference path="interface/definitions.d.ts" />
import { ApiRouter, IResult, IRouterRegister } from '@typeapi/api-router';
...
export declare class Controller implements IController, IRouterRegister {
    private options?;
